export const EMAIL_TEMPLATE_DEFINITIONS = [
  ...
  {
    slug: 'deposit_created',
    label: 'Thông báo nạp tiền',
    description: 'Gửi khi admin hủy, gia hạn hoặc nạp thủ công yêu cầu nạp tiền.',
    type: 'link',
    defaults: {
      subject: 'Cập nhật yêu cầu nạp tiền Kendy Digital',
      heading: 'Cập nhật nạp tiền',
      intro: 'Chào {{name}}, yêu cầu nạp tiền của bạn đã được cập nhật.',
      actionLabel: 'Xem ví',
      detail: 'Mọi thắc mắc vui lòng liên hệ bộ phận hỗ trợ.',
      securityNote: 'Nếu bạn không thực hiện giao dịch này, vui lòng liên hệ admin ngay.',
      footer: 'Đây là email tự động từ Kendy Digital. Vui lòng không trả lời email này.',
    },
  },
  {
    slug: 'wallet_adjusted',
    label: 'Điều chỉnh ví',
    description: 'Gửi khi admin điều chỉnh số dư ví của người dùng.',
    type: 'link',
    defaults: {
      subject: 'Ví của bạn đã được điều chỉnh',
      heading: 'Điều chỉnh ví',
      intro: 'Chào {{name}}, số dư ví của bạn vừa được admin điều chỉnh.',
      actionLabel: 'Xem ví',
      detail: 'Kiểm tra số dư và lịch sử giao dịch để biết thêm chi tiết.',
      securityNote: 'Nếu bạn có thắc mắc về giao dịch này, vui lòng liên hệ hỗ trợ.',
      footer: 'Đây là email tự động từ Kendy Digital. Vui lòng không trả lời email này.',
    },
  },
  {
    slug: 'account_status_changed',
    label: 'Thay đổi trạng thái tài khoản',
    description: 'Gửi khi admin thay đổi trạng thái hoặc quyền của tài khoản.',
    type: 'link',
    defaults: {
      subject: 'Tài khoản Kendy Digital của bạn đã được cập nhật',
      heading: 'Cập nhật tài khoản',
      intro: 'Chào {{name}}, tài khoản của bạn vừa được cập nhật bởi admin.',
      actionLabel: 'Xem bảo mật',
      detail: 'Vào mục Bảo mật để xem chi tiết thay đổi.',
      securityNote: 'Nếu bạn không đồng ý với thay đổi này, vui lòng liên hệ admin ngay.',
      footer: 'Đây là email tự động từ Kendy Digital. Vui lòng không trả lời email này.',
    },
  },
  {
    ...
    description: 'Gửi các cảnh báo bảo mật như bật 2FA, thu hồi phiên đăng nhập.',
    type: 'link',
    defaults: {
      subject: 'Cảnh báo bảo mật Kendy Digital',
      heading: 'Cảnh báo bảo mật',
      intro: 'Chào {{name}}, có hoạt động bảo mật trên tài khoản của bạn.',
      actionLabel: 'Xem bảo mật',
      detail: 'Nếu bạn không thực hiện thao tác này, hãy đổi mật khẩu ngay.',
      securityNote: 'Luật sư của chúng tôi sẽ không bao giờ yêu cầu mật khẩu qua email.',
      footer: 'Đây là email tự động từ Kendy Digital. Vui lòng không trả lời email này.',
    },
  },
  {
    ...
    description: 'Gửi thông báo chung từ hệ thống đến người dùng.',
    type: 'link',
    defaults: {
      subject: 'Thông báo từ Kendy Digital',
      heading: 'Thông báo',
      intro: 'Chào {{name}}, bạn có thông báo mới từ hệ thống.',
      actionLabel: 'Xem chi tiết',
      detail: 'Đăng nhập để xem đầy đủ thông báo.',
      securityNote: 'Đây là thông báo tự động từ hệ thống.',
      footer: 'Đây là email tự động từ Kendy Digital. Vui lòng không trả lời email này.',
    },
  },
]
