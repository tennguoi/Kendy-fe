      ...
      {activeSection === 'email' && (
        <div className="settings-email-grid">
          <div className="admin-panel admin-form settings-panel">
            ...
            <label><span>Nội dung email</span><textarea rows={7} value={form.resetPasswordBody} onChange={(event) => updateForm({ resetPasswordBody: event.target.value })} /></label>
          </div>
          ...
          <div className="admin-panel admin-form settings-panel">
            ...
            <label><span>Nội dung email</span><textarea rows={7} value={form.verifyEmailBody} onChange={(event) => updateForm({ verifyEmailBody: event.target.value })} /></label>
          </div>
          ...
          <div className="admin-panel admin-form settings-panel settings-email-wide">
            ...
            <label><span>Nội dung email</span><textarea rows={7} value={form.twoFactorBody} onChange={(event) => updateForm({ twoFactorBody: event.target.value })} /></label>
